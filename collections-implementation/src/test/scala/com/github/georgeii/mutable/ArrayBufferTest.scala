...
class ArrayBufferTest extends flatspec.AnyFlatSpec {

  "An ArrayBuffer" should "have length 0 after initialization" in {
    val arrayBuffer = new ArrayBuffer[Int]()
    assert(arrayBuffer.length == 0)
  }

  it should "be able to be declared as a structure of different types: whether it is Value or Reference type" in {
    val bufferOfInts = new ArrayBuffer[Int]()
    ...
    val bufferOfOptions = new ArrayBuffer[Option[Int]]()
